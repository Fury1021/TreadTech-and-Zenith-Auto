...
<body>
    ...
    <div class="form-container">
        ...
        <!-- Redirects to the admin_register_action.php to handle the action-->
        <form action="admin_register_action.php" method="post" enctype="multipart/form-data">
            <div class="row">
                <div class="col-md-6">
        ...
        <p class="mt-3 text-center">
            <!--redirects to login-->
            <a href="admin_login.php">Already have an account?</a><br>
